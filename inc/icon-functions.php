 ...
 */
function bon_appetit_include_svg_icons() {
...
add_action( 'wp_footer', 'bon_appetit_include_svg_icons', 9999 );
 ...
 */
function bon_appetit_get_svg( $args = array() ) {
	 ...
	 *
	 * Example 1 with title: <?php echo bon_appetit_get_svg( array( 'icon' => 'arrow-right', 'title' => __( 'This is the title', 'textdomain' ) ) ); ?>
	 *
	 * Example 2 with title and description: <?php echo bon_appetit_get_svg( array( 'icon' => 'arrow-right', 'title' => __( 'This is the title', 'textdomain' ), 'desc' => __( 'This is the description', 'textdomain' ) ) ); ?>
	 *
	...
	if ( 'social' === $args->theme_location ) {
		foreach ( $social_icons as $attr => $value ) {
			if ( false !== strpos( $item_output, $attr ) ) {
				$item_output = str_replace( $args->link_after, '</span>' . bon_appetit_get_svg( array( 'icon' => esc_attr( $value ) ) ), $item_output );
			}
		}
	}
	...
	if ( 'top' === $args->theme_location ) {
		foreach ( $item->classes as $value ) {
			if ( 'menu-item-has-children' === $value || 'page_item_has_children' === $value ) {
				$title = $title . bon_appetit_get_svg( array( 'icon' => 'angle-down' ) );
			}
		}
	}
